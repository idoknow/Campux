...
CREATE TABLE "SchoolEntity" (
    ...
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "SchoolEntity_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Tenant" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "SchoolModelSnapshot" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "SchoolModelSnapshot_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Tenant" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "PostAiAnalysis" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "PostAiAnalysis_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Tenant" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "PostAiAnalysis_postId_fkey" FOREIGN KEY ("postId") REFERENCES "Post" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "PostAiAnalysis_modelSnapshotId_fkey" FOREIGN KEY ("modelSnapshotId") REFERENCES "SchoolModelSnapshot" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
...
CREATE TABLE "AiBackfillBatch" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "AiBackfillBatch_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Tenant" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "AiBackfillBatch_actorId_fkey" FOREIGN KEY ("actorId") REFERENCES "User" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
...
CREATE TABLE "AiBackfillItem" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "AiBackfillItem_batchId_fkey" FOREIGN KEY ("batchId") REFERENCES "AiBackfillBatch" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "AiBackfillItem_postId_fkey" FOREIGN KEY ("postId") REFERENCES "Post" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "AiBackfillLog" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "AiBackfillLog_batchId_fkey" FOREIGN KEY ("batchId") REFERENCES "AiBackfillBatch" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
