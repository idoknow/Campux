...
import { registerGraduationRoutes } from "./routes/graduations";
import { registerTodayInHistoryRoutes } from "./routes/today-in-history";
...
registerGraduationRoutes(app, config, oneBot);
